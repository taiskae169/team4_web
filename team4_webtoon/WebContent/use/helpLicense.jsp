...
<h3 class = "welcome"><a id = "welcome" name = "welcome"></a>여러분을 환영합니다.</h3>
<br>
<p>
...
<div class = "box">
<h3 class = "service"><a id = "service" name = "service"></a>다양한 서비스를 즐겨보세요</h3>
<p>
...
<div class = "box">
<h3 class = "register"><a id = "register" name = "register"></a>회원으로 가입하시면 보다 편리하게 이용할 수 있습니다.</h3>
...
<div class = "box">
<h3 class = "content"><a id = "content" name = "content"></a>여러분이 제공한 콘텐츠를 소중히 다룰 것입니다.</h3>
<p>
