...
<a style = "display:scroll;position:fixed;bottom:250px;right:300px;" href = "#" title = top>
<img src = ../resources/image/use/top.jpg border = "0"/>
</a>
...
<a href = "#service" class = "color">다양한 서비스를 즐겨보세요.</a><br>
<a href = "#register" class = "color">회원으로 가입하시면 보다 편리하게 이용할 수 있습니다.</a><br>
<a href = "#content" class = "color">여러분이 제공한 콘텐츠를 소중히 다룰 것입니다.</a><br>

<a href = "#secure" class = "color">여러분의 개인정보를 소중히 보호합니다.</a>
<hr>
<div class = "box">


<h3 class = "welcome">여러분을 환영합니다.</h3>
<br>
<p>
네이버 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 네이버 서비스의 이용과 관련하여 네이버 서비스를 제공하는 네이버 주식회사(이하 ‘네이버’)와 이를 이용하는 네이버 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 네이버 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
<br><a id = "service" name = "service"></a><br>
네이버 서비스를 이용하시거나 네이버 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로, 잠시 시간을 내시어 주의 깊게 살펴봐 주시기 바랍니다
</p>
</div>

<div class = "box">
<h3 class = "service">다양한 서비스를 즐겨보세요</h3>
<p>
...
<br><a id = "register" name = "register"></a><br>
...
<div class = "box">
<h3 class = "register">회원으로 가입하시면 보다 편리하게 이용할 수 있습니다.</h3>
...
<div class = "box">
<h3 class = "secure"><a id = "secure" name = "secure"></a>여러분의 개인정보를 소중히 보호합니다.</h3>
<p>
